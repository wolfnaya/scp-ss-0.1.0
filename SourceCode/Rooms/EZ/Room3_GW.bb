...
Function FillRoom_Room3_GW(r.Rooms)
	...
	d = CreateDoor(r\zone, r\x - 728.0 * RoomScale, 0.0, r\z - 458.0 * RoomScale, 0, r, False, False, KEY_CARD_3)
	d\AutoClose = False	: d\open = False  : d\locked = False
	
	d = CreateDoor(r\zone, r\x - 223.0 * RoomScale, 0.0, r\z - 736.0 * RoomScale, -90, r, False, False, KEY_CARD_3)
	d\AutoClose = False	: d\open = False  : d\locked = False
	
	r\RoomDoors[0] = CreateDoor(r\zone, r\x - 459.0 * RoomScale, 0.0, r\z + 339.0 * RoomScale, 90, r, False, DOOR_WINDOWED)
	...
	r\RoomDoors[1] = CreateDoor(r\zone, r\x + 385.0 * RoomScale, 0.0, r\z + 339.0 * RoomScale, 270, r, False, DOOR_WINDOWED)
