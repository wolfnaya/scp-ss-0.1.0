...
;	Next
	...
	r\Objects[18] = LoadTexture_Strict("GFX\Npcs\pdplane.png",1+2,2)
	;HideEntity(r\Objects[18])
	r\Objects[19] = LoadTexture_Strict("GFX\Npcs\pdplaneeye.png",1+2,2)
		...
		Case HCZ
			For e2.Events = Each Events
				If gopt\GameMode = GAMEMODE_NTF Then
					...
					EndIf
				Else
					If e2\EventName = "room2_nuke" And e2\EventState[0] = 0 Then
						temp = True
						Exit
					EndIf
				EndIf
	...
	For r.Rooms = Each Rooms
		If gopt\CurrZone = HCZ Then
			If gopt\GameMode = GAMEMODE_NTF Then
				...
				EndIf
			Else
				If r\RoomTemplate\Name = "room2_nuke" And temp Then
					TeleportEntity(Collider,EntityX(r\obj,True),0.4,EntityZ(r\obj,True),0.3,True)
					Exit
				EndIf
			EndIf
			If r\RoomTemplate\Name = "core_hcz" And random <= 3 And (Not temp) Then
				TeleportEntity(Collider,EntityX(r\obj,True),0.4,EntityZ(r\obj,True),0.3,True)
				Exit
